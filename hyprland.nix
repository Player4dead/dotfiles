...
exec-once = fluent-reader
exec-once = discord
exec-once = firefox
exec-once = sleep 1 & swww img $HOME/.dotfiles/modules/wp6396639-metro-exodus-desktop-pc-wallpapers.jpg
exec-once = keepassxc
...
bind = $mainMod, I, exec, librewolf & i2prouter
bind = , Print, exec, grim -g "$(slurp)"
bind = $mainMod, Z, exec, zettlr
bind = $mainMod, W, exec, pkill waybar && waybar
bind = $mainMod, T, exec, cd /home/player4dead/extern/planka && docker compose up -d
